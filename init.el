...
(set-face-attribute 'default nil :font "JetBrains Mono:pixelsize=16:foundry=JB:weight=bold:slant=normal:width=normal:spacing=100:scalable=true" :height 100)
...
;; The ultimate refactoring package !
(use-package iedit)            ; C-; to toggle refactoring under point
